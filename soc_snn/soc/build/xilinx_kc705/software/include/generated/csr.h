...
#define CSR_EDABK_SNN_PACKET_IN_ADDR (CSR_BASE + 0x44L)
#define CSR_EDABK_SNN_PACKET_IN_SIZE 1
static inline uint32_t edabk_snn_packet_in_read(void) {
	return csr_read_simple(CSR_BASE + 0x44L);
}
static inline void edabk_snn_packet_in_write(uint32_t v) {
