...
/* display */
#define CSR_DISPLAY_BASE (CSR_BASE + 0x800L)
#define CSR_DISPLAY_SEL_ADDR (CSR_BASE + 0x800L)
...
#define CSR_DISPLAY_VALUE_ADDR (CSR_BASE + 0x804L)
...
#define CSR_DISPLAY_WRITE_ADDR (CSR_BASE + 0x808L)
