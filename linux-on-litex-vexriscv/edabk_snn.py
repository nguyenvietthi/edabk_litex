...
class edabk_snn(Module, AutoCSR, AutoDoc):
    def __init__(self, platform):
        ...
        platform.add_source_dir("../soc_snn/seq_snn/hdl")
        platform.add_source_dir("../soc_snn/seq_snn/libs/async_fifo/hdl")
        platform.add_source_dir("../soc_snn/seq_snn/libs/snn_1x1/hdl")
        platform.add_source_dir("../soc_snn/seq_snn/libs/sync_signal/hdl")
